...
renderNews = function renderNews() {
  console.log("WORKS");
  ...
  $.get("/user/" + user_id + "/news", function (data) {
    for (var v in friends) {
      var _iterator = _createForOfIteratorHelper(friends[v].news),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var item = _step.value;
          $("#news_container").append("<div class=card> <div class=card-header>" + friends[v].full_name + "</div><div class=card-body><p class=card-text>" + item + "</p></div></div>");
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
...
(() => {
/*!*********************************************!*\
  !*** ./webpack_entry_point/webpack_news.js ***!
  \*********************************************/
