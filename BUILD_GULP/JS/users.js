...
function renderUsers() {
  ...
  $.get("/users", {
    ...
    for (var v in users) {
      //console.log(v);
      var act = "/user/" + users[v].id + "/friends"; //$("#users_table").before("<form action="+act+" id=friends_"+users[v].id+"></form>");
...
renderUsers(); //onclick=goToFriends(this) id=friends_"+users[v].id+"